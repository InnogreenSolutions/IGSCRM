...
const people = [
  { ...companyRoles.owner, tone: 'indigo', availability: 'Owner & Operator' },
  { ...companyRoles.salesOperationsManager, tone: 'mint', availability: 'Sales & sales operations' },
...
function App() {
  ...
  const saveVoice = () => {
    ...
    setVoiceText('');
    setShowVoice(false);
    setMessage('Voice memo saved. A review task was added to TJ’s sales operations queue.');
  };
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          ...
          <span className="eyebrow gold">OWNER ONLY · ROMEO</span>
      ...
      <main className="main">
        <header className="topbar">
          <div><span className="eyebrow mint">{companyRoles.owner.role}</span><h1>{active === 'Command Center' ? `Welcome, ${companyRoles.owner.name}.` : active}</h1><p>{message}</p></div>
